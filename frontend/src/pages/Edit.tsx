...
export default function Edit() {
    const { API_BASE_URL, notify, fetchEmployee, employee, EMPLOYEE_URL, employeeImageBaseUrl,} = useContext(Context);
    ...
    formData.append("contact_no", contactnoRef.current.value);
    if (e.target.employee_image.files.length != 0) {
      formData.append("employee_image", e.target.employee_image.files[0]);
  }


axios.put( API_BASE_URL + EMPLOYEE_URL +  "/update/" + id, formData
).then (
  (success) => {
...
;
    ...
    return (
        ...
        <div className="relative z-0 w-full mb-5 group">
                              ...
                              >
                                Current  Image:
                                <img width={100} height={100} src={`${API_BASE_URL}${employeeImageBaseUrl}/${employee.image_name}`} alt="" />
